...
\hrule
\begin{flushleft}
Plik : \textcolor{Red}{C:$\backslash$Users$\backslash$Admin$\backslash$Documents$\backslash$GitHub$\backslash$Skradzione\_wzory$\backslash$Plagiator3000$\backslash$TEXfiles$\backslash$copy7$\backslash$2.tex}\\
{\huge Stopień podobieństwa: \textcolor{Red}{NaN}\%} \\ 
