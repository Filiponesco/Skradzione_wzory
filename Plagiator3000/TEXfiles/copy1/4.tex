...
\begin{document}
   ...
   Diam sit amet nisl suscipit adipiscing. Urna nec tincidunt praesent semper feugiat nibh sed pulvinar proin $ \lim\left ( a_n-b_n \right )=a-b $.
   \newline
    
    Quis enim lobortis scelerisque fermentum dui faucibus in ornare \( n_{k+1} ) \).
    \newline
