...
\begin{document}
   ...
   Diam sit amet nisl suscipit adipiscing. Urna nec tincidunt praesent semper feugiat nibh sed pulvinar proin $ x^{2+a} $.
   \newline
    
    Quis enim lobortis scelerisque fermentum dui faucibus in ornare \( \lim\left ( a_n-b_n \right )=a-b \).
    \newline
