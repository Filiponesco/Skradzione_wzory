...
\begin{document}
   ...
   Diam sit amet nisl suscipit adipiscing. Urna nec tincidunt praesent semper feugiat nibh sed pulvinar proin $ \int_0^2x^2dx $.
   \newline
    
    Quis enim lobortis scelerisque fermentum dui faucibus in ornare \( \log _{a}(x\cdot y)=\log _{a}x+\log _{a}y \).
    \newline
